...
const allImages = [
    { src: img0, alt: 'Интерьер ресторана La Piada' },
    { src: img1, alt: 'Атмосфера итальянского ресторана La Piada' },
    { src: img2, alt: 'Интерьер ресторана La Piada' },
    { src: img3, alt: 'Атмосфера итальянского ресторана La Piada' },
    { src: img4, alt: 'Интерьер ресторана La Piada' },
    { src: img5, alt: 'Атмосфера итальянского ресторана La Piada' },
    { src: img6, alt: 'Интерьер ресторана La Piada' },
    { src: img7, alt: 'Атмосфера итальянского ресторана La Piada' },
    { src: img8, alt: 'Интерьер ресторана La Piada' },
    { src: img9, alt: 'Атмосфера итальянского ресторана La Piada' },
    { src: img10, alt: 'Интерьер ресторана La Piada' },
];
        ...
        <section id="vibe" className="gallery-section">
            <div className="container">
                <div className="section-header">
                    ...
                    <p className="section-desc">Аутентичная итальянская атмосфера в центре Санкт-Петербурга.</p>
                </div>
