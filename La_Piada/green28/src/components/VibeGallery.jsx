...
const allImages = [
    { src: img0, alt: 'Интерьер ресторана Green 28' },
    { src: img1, alt: 'Атмосфера заведения Green 28' },
    { src: img2, alt: 'Интерьер ресторана Green 28' },
    { src: img3, alt: 'Атмосфера заведения Green 28' },
    { src: img4, alt: 'Интерьер ресторана Green 28' },
    { src: img5, alt: 'Атмосфера заведения Green 28' },
    { src: img6, alt: 'Интерьер ресторана Green 28' },
    { src: img7, alt: 'Атмосфера заведения Green 28' },
    { src: img8, alt: 'Интерьер ресторана Green 28' },
    { src: img9, alt: 'Атмосфера заведения Green 28' },
    { src: img10, alt: 'Интерьер ресторана Green 28' },
];
        ...
        <section id="vibe" className="gallery-section">
            <div className="container">
                <div className="section-header">
                    ...
                    <p className="section-desc">Уютное пространство в сердце Санкт-Петербурга.</p>
                </div>
