        ...
        <section id="menu" className="menu-section">
            <div className="container">
                <div className="menu-description">
                    <p>Green 28 — ресторан и бар в Санкт-Петербурге.</p>
                    <p>Мы предлагаем современную кухню с акцентом на свежие ингредиенты и сбалансированные вкусы. В нашем меню представлены блюда, сочетающие традиции и современные техники приготовления.</p>
                    <p>Мы готовим закуски, салаты, супы, горячие блюда, завтраки и десерты. В баре вы найдете широкий выбор напитков. Мы создаем уютную атмосферу, где можно насладиться вкусной едой и хорошей компанией.</p>
                </div>
